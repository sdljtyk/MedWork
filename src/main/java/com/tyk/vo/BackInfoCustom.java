...
public class BackInfoCustom {
	...
	public String getBackstatemc() {
		return backstatemc;
	}
	public void setBackstatemc(String backstatemc) {
		this.backstatemc = backstatemc;
	}
